  ...
  fluidPage(
    ...
    sidebarPanel(
      ...
      sliderInput('m', 'Exponente de phi (m)', value = 10,
                  min = 1, max = 10, step = 1),
      selectInput('g1', 'Función de muestreo g1', c('U(-1,1)'=1,'N(0,1)'=2,'N(0,4)'=3,'N(-1,1)'=4,'N(0,0.3)'=5), selected = 1),
      selectInput('g2', 'Función de muestreo g2', c('U(-1,1)'=1,'N(0,1)'=2,'N(0,4)'=3,'N(-1,1)'=4,'N(0,0.3)'=5), selected = 2)
